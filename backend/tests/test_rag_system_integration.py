...
class TestRAGSystemQueryFlow:
    ...
    def test_successful_content_query_flow(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_vector_store_instance.get_lesson_link.return_value = "http://example.com/lesson1"
        
        # Mock AI generator that uses tools
        mock_ai_instance = Mock()
        mock_ai_gen.return_value = mock_ai_instance
        mock_ai_instance.generate_response.return_value = "Python is a high-level programming language used for various applications."
        ...
        # Verify the flow
        assert response == "Python is a high-level programming language used for various applications."
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_query_without_session(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_vector_store_error_propagation(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_ai_instance = Mock()
        mock_ai_gen.return_value = mock_ai_instance
        mock_ai_instance.generate_response.return_value = "I'm sorry, I couldn't search the course materials due to a database error."
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_ai_generator_error_handling(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_ai_instance = Mock()
        mock_ai_gen.return_value = mock_ai_instance
        mock_ai_instance.generate_response.side_effect = Exception("AI API connection failed")
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_tool_registration_on_initialization(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_sources_tracking_and_reset(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_vector_store_instance.search.return_value = search_results
        mock_vector_store_instance.get_lesson_link.return_value = "http://example.com/lesson"
    ...
    def test_real_tool_execution_flow(self, mock_config):
        ...
        # Test tool execution
        result = tool_manager.execute_tool("search_course_content", query="What is Python?")
...
class TestRAGSystemInitialization:
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_component_initialization(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_initialization_with_missing_config(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen):
...
class TestRAGSystemCourseManagement:
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_add_course_document_success(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config, sample_course, sample_course_chunks):
        ...
        mock_doc_proc_instance.process_course_document.assert_called_once_with("test_course.txt")
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_add_course_document_error(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
    ...
    def test_add_course_folder(self, mock_listdir, mock_exists, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config, sample_course, sample_course_chunks):
    ...
    @patch('rag_system.DocumentProcessor')
    @patch('rag_system.SessionManager')
    def test_get_course_analytics(self, mock_session_mgr, mock_doc_proc, mock_vector_store, mock_ai_gen, mock_config):
        """Test course analytics retrieval"""
        # Setup vector store mock
        mock_vector_store_instance = Mock()
        mock_vector_store.return_value = mock_vector_store_instance
        mock_vector_store_instance.get_course_count.return_value = 5
        mock_vector_store_instance.get_existing_course_titles.return_value = ["Course A", "Course B", "Course C"]
