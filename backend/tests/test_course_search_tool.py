...
class TestCourseSearchToolExecute:
    ...
    def test_search_with_course_name_filter(self, mock_vector_store, successful_search_results):
        """Test search with course name filtering"""
        mock_vector_store.search.return_value = successful_search_results
        search_tool = CourseSearchTool(mock_vector_store)
        
        result = search_tool.execute("What is Python?", course_name="Python Fundamentals")
    ...
    def test_search_with_lesson_number_filter(self, mock_vector_store, successful_search_results):
    ...
    def test_empty_results_with_both_filters(self, mock_vector_store, empty_search_results):
        """Test empty results message includes both filter info"""
        mock_vector_store.search.return_value = empty_search_results
        search_tool = CourseSearchTool(mock_vector_store)
        
        result = search_tool.execute("nonexistent", course_name="Python", lesson_number=5)
...
class TestCourseSearchToolIntegration:
    ...
    def test_sources_retrieval_through_tool_manager(self, mock_vector_store, successful_search_results):
...
class TestCourseSearchToolErrorConditions:
    ...
    def test_special_characters_in_query(self, mock_vector_store, successful_search_results):
